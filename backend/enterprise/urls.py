...
from .views import EnterpriseViewSet, RecruitmentViewSet, JobApplicationViewSet, TalentPoolViewSet, TalentPoolTagViewSet, RecruitmentFavoriteViewSet
# 注册视图集
...
router.register(r'favorites', RecruitmentFavoriteViewSet, basename='recruitment_favorite')  # 职位收藏接口
# 应用内路由
urlpatterns = [
